...
grc = {
    "lemma_index": get_file("grc_lemma_index.json"),
    "lemma_lookup_adj": get_file("grc_lemma_lookup_adj.json"),
    "lemma_lookup_adp": get_file("grc_lemma_lookup_adp.json"),
    "lemma_lookup_adv": get_file("grc_lemma_lookup_adv.json"),
    "lemma_lookup_noun": get_file("grc_lemma_lookup_noun.json"),
    "lemma_lookup_num": get_file("grc_lemma_lookup_num.json"),
    "lemma_lookup_part": get_file("grc_lemma_lookup_part.json"),
    "lemma_lookup_pron": get_file("grc_lemma_lookup_pron.json"),
    "lemma_lookup_verb": get_file("grc_lemma_lookup_verb.json"),
    "lemma_lookup_sconj": get_file("grc_lemma_lookup_sconj.json"),
    "lemma_lookup_intj": get_file("grc_lemma_lookup_intj.json"),
    "lemma_lookup_det": get_file("grc_lemma_lookup_det.json"),
    "lemma_lookup_cconj": get_file("grc_lemma_lookup_cconj.json"),
}
